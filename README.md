...
- Implemented Mapper 41 (Caltron / Myriad): A complex multicart architecture that utilizes an outer register for PRG selection and an inner register for CHR selection, complete with a physical hardware lockout switch. Example games: Caltron 6-in-1 and Myriad 6-in-1 (MULTI-BOOT CURRENTLY NOT WORKING)
